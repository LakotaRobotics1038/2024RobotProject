...
public class Trajectories {
    ...
    // return new PathPlannerTrajectory(Paths.pathFromPosition2ToSpeaker,
    // DriveTrain.getInstance().getChassisSpeeds(),
    // Rotation2d.fromDegrees(DriveTrain.getInstance().getHeading()));
    // }
    ...
    // return new PathPlannerTrajectory(Paths.pathFromPosition3ToMidline,
    // DriveTrain.getInstance().getChassisSpeeds(),
    // Rotation2d.fromDegrees(DriveTrain.getInstance().getHeading()));
    // }
    ...
    // return new PathPlannerTrajectory(Paths.pathFromPosition3ToSpeaker,
    // DriveTrain.getInstance().getChassisSpeeds(),
    // Rotation2d.fromDegrees(DriveTrain.getInstance().getHeading()));
    // }

    // public static PathPlannerTrajectory getFromSpeakerToMidlineTrajectory() {
    // return new PathPlannerTrajectory(Paths.pathFromSpeakerToMidline,
    // DriveTrain.getInstance().getChassisSpeeds(),
    // Rotation2d.fromDegrees(DriveTrain.getInstance().getHeading()));
    // }
