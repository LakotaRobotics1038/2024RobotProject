...
public class Paths {
    ...
    // public static PathPlannerPath pathFromAmpRollingOverNoteToMidline =
    // PathPlannerPath
    // .fromPathFile("From amp to midline rolling over note");
    public static PathPlannerPath taxiPath1 = PathPlannerPath
            .fromPathFile("Taxi Position 1");
    ...
    // public static PathPlannerPath pathFromNote2ToSpeaker =
    // PathPlannerPath.fromPathFile("From middle note to speaker");

    // public static PathPlannerPath pathFromNote3ToSpeaker =
    // PathPlannerPath.fromPathFile("From bottom note to speaker");
    ...
    // public static PathPlannerPath pathFromSpeakerToNote2 =
    // PathPlannerPath.fromPathFile("From speaker to middle note");

    // public static PathPlannerPath pathFromSpeakerToNote3 =
    // PathPlannerPath.fromPathFile("From speaker to bottom note");

    // public static PathPlannerPath pathFromSpeakerToMidline =
    // PathPlannerPath.fromPathFile("From speaker to midline");
